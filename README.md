...
1. (Optional) In this repository, use `scripts/build_from_bib.sh` to generate `_data/generated_publications.json` and `_data/generated_talks.json` from the BibTeX sources, then rebuild the site.
