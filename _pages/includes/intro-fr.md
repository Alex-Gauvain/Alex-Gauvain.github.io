...
- Modélisation hydrologique et hydrogeologique multi-échelles, des versants et bassins versants à l'hydrologie planétaire.
- Contraintes multi-sources pour les modèles de nappes à partir d'observations de terrain, de traceurs, de réseaux hydrographiques et de données géospatiales.
- Temps de transit des eaux souterraines, dynamiques de recharge, interactions eaux souterraines-eaux de surface et impacts du changement climatique sur les ressources en eau.
...
<div class="media-animation">
    <div style="display: grid; grid-template-columns: minmax(0, 2.1fr) minmax(0, 1fr); gap: 1rem; align-items: center; width: 100%;">
        <img
            ...
            alt="Animation de la dynamique des eaux souterraines en zone côtière"
            style="display: block; width: 100%; max-width: 630px; height: auto; justify-self: end;">
        <img
            src="{{ '/files/mars.gif' | relative_url }}"
            alt="Animation d'un modele hydrologique global sur Mars"
...
Des contenus de diffusion scientifique sont disponibles dans la section [Diffusion scientifique]({{ '/fr/outreach/' | relative_url }}).